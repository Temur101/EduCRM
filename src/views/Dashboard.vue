...
const loadDashboardData = async () => {
  ...
  try {
    ...
    // 1 & 2 & 3. Leads, Tasks, Payments (Admin & Regular)
    if (userRoleVal === 'admin' || userRoleVal === 'regular') {
      promises.push(
...
<template>
  <div class="dashboard-view">
    ...
    <!-- Stats Summary Row (Admins & Regular Staff) -->
    <div class="stats-grid" v-if="userRole === 'admin' || userRole === 'regular'">
    ...
    <div class="stats-grid overview-stats">
      ...
      <template v-else>
        ...
        />
        <StatCard 
          v-if="userRole === 'admin' || userRole === 'regular'"
    ...
    <div class="dashboard-content-grid" v-if="userRole === 'admin' || userRole === 'regular'">
