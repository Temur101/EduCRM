    ...
    <div v-if="show" class="modal-overlay" @click.self="close">
      <div class="modal-box payment-modal">
        ...
        <div class="modal-body">
          ...
          <!-- Student Selector (Improved: Always visible list) -->
          <div v-if="!props.initialStudentId && !showSuccessScreen && !studentId" class="student-select-section">
            ...
            <div class="student-inline-list">
              ...
              >
                ...
                <div class="std-info">
                  ...
                  <span class="std-phone">{{ s.phone || '-' }}</span>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="pc-day-grid">
                <button
                  ...
                  :class="{
                    ...
                    // Attendance colors
                    'pc-chip-att-present': payMonthAttMap[d.dateStr] === 'present',
                    'pc-chip-att-absent':  payMonthAttMap[d.dateStr] === 'absent',
                    'pc-chip-att-sick':    payMonthAttMap[d.dateStr] === 'sick',
                    'pc-chip-att-late':    payMonthAttMap[d.dateStr] === 'late'
                  }"
        ...
        <div class="modal-footer">
          ...
          >
            ...
            <span v-else>{{ $t('students.payNow') }}</span>
          </button>
          <button 
            v-else
            class="btn-primary" 
...
.pc-chip-att-present { background: #D1FAE5 !important; color: #059669 !important; border-color: #6EE7B7 !important; }
